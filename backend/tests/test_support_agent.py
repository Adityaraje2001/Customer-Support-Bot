...
def test_run(support_agent, mock_rag_service):
    # Arrange
    mock_rag_service.answer_question.return_value = "This is a support answer."

    # Act
    response = support_agent.run(question="How do I use the app?", history=[])

    # Assert
    assert response == "This is a support answer."
